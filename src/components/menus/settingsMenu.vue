<template>
  <a-entity>
      <a-entity @mousedown="toggleMenu" geometry="primitive:box; width:0.03; height: 0.03; depth: 0.03;" position="0 0 0.20" material="color:blue" data-collides rotation="0 0 0"></a-entity>
