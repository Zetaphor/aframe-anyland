<template>
  <a-entity>
      <a-entity @mousedown="toggleMenu" geometry="primitive:box; width:0.03; height: 0.03; depth: 0.03;" position="0 0 0.20" material="color:blue" class="collidable" rotation="0 0 0"></a-entity>
      <a-entity v-if="showMenu" geometry="primitive:box; width:0.01; height: 0.25; depth: 0.25;" position="0 0.2 0" material="color:#333" class="collidable" rotation="0 0 0">
        ...
        <gui-button rotation="0 90 0" position="0.011 0.1 -0.06" :event="'resetZPos'" :useBus="true" :width="0.1" :height="0.04" :value="$store.state.enableFlying" text="Reset Z Position"></gui-button>
